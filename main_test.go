...
stdout_logfile = /var/log/supervisor/ch-test}.log
autorestart=true
...
stdout_logfile_maxbytes = 40MB
stdoiut_logfile_backups = 20
stdout_logfile = /var/log/supervisor/ch-anothertest1}.log
autorestart=true
startretries=5000000000
stopasgroup=true
killasgroup=true
...
stdout_logfile_maxbytes = 40MB
stdoiut_logfile_backups = 20
stdout_logfile = /var/log/supervisor/ch-proxy-test.log
autorestart=true
startretries=5000000000
stopasgroup=true
killasgroup=true
...
stdout_logfile_maxbytes = 40MB
stdoiut_logfile_backups = 20
stdout_logfile = /var/log/supervisor/ch-proxy-anothertest1.log
autorestart=true
startretries=5000000000
stopasgroup=true
killasgroup=true
